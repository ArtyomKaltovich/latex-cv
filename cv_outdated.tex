...
\begin{tabular}[\textwidth]{ll}
    ...
    & \large\textnormal{\includegraphics[height=0.7\baselineskip]{rosalind.png} {\href{http://rosalind.info/users/kaltovichartyom/}{kaltovichartyom}}} \vspace{2mm} \\
...
\begin{tabular}{lp{10cm}}
    Programming Languages:& \small Assembler (x86, z/OS, BS2000 OSD), C,C++, C\#, Cobol, Delphi, \textbf{Groovy}, Java, \textbf{Python}, SPL, SQL, Ruby \\ 
    Web Technologies:&\small .NET, J2EE, Django, Flask, Ruby on Rails\\ 
    Databases:&\small MS SQL, \textbf{MySQL}, SQLite, UDS/SQL, OneTick\\ 
    Operating Systems:&\small Android, BS2000 OSD, \textbf{Linux}, Windows, z/OS\\ 
    Other Skills:&\small \textbf{git}, Mathematica, Octave(Matlab), MiniZinc, \LaTeX, HTML, CSS, IDEF, UML, VHDL, Sphinx\\ 
\end{tabular} 
...
\begin{longtable}{lr|p{11cm}}
    % OneTick
    \WorkExpCompany{Sep 2019 - present}{Big Data Solutions}
    \WorkExpProject{Sep 2018 - present}
        {\makecell[r]{Software Engineer}}
        {Creating Pandas-like wrapper for OneTick database query language}
        {Creating architecture and implementing of Pandas-like representation of OneTick query language and database objects. Creating tests for implementation.\linebreak
        Collaboration with OneTick developers for simplifying and improvment of the wrapper. Code reviewing. Creating and updating Sphinx doc.}
        {Python, OneTick, Sphinx, pytest, fintech}
        
    % SK Hynix
    \WorkExpCompany{Jun 2018 - Aug 2019}{SK Hynix Memory Solutions Eastern Europe}
...
\begin{tabular}[\textwidth]{r|p{11cm}}
    ...
    \em Sep 2019 - present  & \textbf{Bionformatic Institute}, \textit{Saint-Petersburg} \\
...
\begin{tabular}[\textwidth]{r|p{13cm}}
    ...
    & \textit{\textcyrillic{Теория вероятностей} (Probability theory)} - Computer Science Center (CSC - JetBrains, St.Petersburg)\\
    & \textit{\textcyrillic{Молекулярная биология клетки} (Cell Molecular Biology)} - Bioinformatics Institute, St.Petersburg\\
    \multicolumn{2}{c}{} \\	
